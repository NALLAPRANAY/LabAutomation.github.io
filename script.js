...
const sheetId = "1140nRuzCveaPi_hBGStIISNAc9n9p4lZMccXrcbdev0";
...
$.ajax({
  ...
  success: function (response) {
    ...
    name1.innerHTML=data[0]["full_name"];
   
    name2.innerHTML=data[1]["full_name"];
    name3.innerHTML=data[2]["full_name"];
    name4.innerHTML=data[3]["full_name"];
    name5.innerHTML=data[4]["full_name"];
    name6.innerHTML=data[5]["full_name"];
    name7.innerHTML=data[6]["full_name"];
    name8.innerHTML=data[7]["full_name"];
    name9.innerHTML=data[8]["full_name"];
    ...
    desg1.innerHTML=data[0]["Designation"];
    desg2.innerHTML=data[1]["Designation"];
    desg3.innerHTML=data[2]["Designation"];
    desg4.innerHTML=data[3]["Designation"];
    desg5.innerHTML=data[4]["Designation"];
    desg6.innerHTML=data[5]["Designation"];
    desg7.innerHTML=data[6]["Designation"];
    desg8.innerHTML=data[7]["Designation"];
    desg9.innerHTML=data[8]["Designation"];
    ...
    time6.innerHTML=data[5]["Time"];
    time7.innerHTML=data[6]["Time"];
    time8.innerHTML=data[7]["Time"];
    time9.innerHTML=data[8]["Time"];
